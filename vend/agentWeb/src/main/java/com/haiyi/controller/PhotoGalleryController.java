...
public class PhotoGalleryController extends BaseController<PhotoGallery, PhotoGalleryQuery> {
    ...
    @RequestMapping(value="/photoGalleryByName",method = RequestMethod.POST)
    public @ResponseBody Map<String,Object> findByName(PhotoGalleryQuery e){
        Map<String,Object> result = new HashMap<String,Object>();
        PageInfo<PhotoGallery> results = baseService.findBySelective(e);
        result.put("photoGallerys",results.getList());
