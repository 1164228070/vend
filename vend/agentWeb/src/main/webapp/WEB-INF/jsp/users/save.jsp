              ...
              <div class="box-body">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <form:input id="userRate" path="rate"  cssClass="form-control" placeholder="费率" data-bv-notempty="true"/>
                    </div>
                  </div>
  ...
  <script type="text/javascript">
    $(function(){
      $("#userRate").change(function () {
        ...
        if(userRate<agentRate || userRate>1 || userRate==null || userRate==""){
          $("#userRate").val("");
          alert("商户费率不能低于代理商费率且必须小于1,并且不能为空");
        }
      });
