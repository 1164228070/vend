          ...
          <div class="col-xs-12">
            <div class="box box-success">
              ...
              <div class="box-body">
                ...
                <div id="toolbar">
                  <mz:menuTag menuURL="/userCashApplys/add">
                    <a href="${pageContext.request.contextPath}/userCashApplys/new" type="button" class="btn bg-maroon btn-flat">添加</a>
                  </mz:menuTag>
                </div>
      ...
      $("#searchForm").on("submit",function(e){
  	  ...
  	  $table = $('#userCashApply_table').bootstrapTable({
          ...
          onLoadSuccess: function () {
            var type="${user.type}";
            if(type == "user"){
              $table.bootstrapTable('hideColumn', 'agentMoney');
            }
            //加载成功触发
          },
