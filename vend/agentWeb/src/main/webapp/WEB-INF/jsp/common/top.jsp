<%@ page language="java" contentType="text/html; charset=UTF-8"
  ...
  <header class="main-header">
    ...
    <a href="javascript:;" class="logo">
      ...
      <span id="logominiId" class="logo-mini">代理商管理系统</span>
      <!-- logo for regular state and mobile devices -->
      <span id="logolgId" class="logo-lg">代理商管理系统</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">${sessionScope.user.loginName}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="${pageContext.request.contextPath}/profile" class="btn btn-default btn-flat">个人中心</a>
                </div>
...
<script type="text/javascript">
  var type="${user.type}";
  if(type == "user"){
    $("#logominiId").text("商户管理系统");
    $("#logolgId").text("商户管理系统");
  }
</script>
