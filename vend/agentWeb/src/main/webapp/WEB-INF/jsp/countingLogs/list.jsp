    ...
    $(function (){
    	...
    	$("#toolbar > button").click(function(){
    		...
    		if("delete"==ope){
    			...
    			request.ajax("${pageContext.request.contextPath}/countingLogs/"+ids,"delete",{},true,function(data){
    				if(data.success){
    					//TODO 确保参数问题？？？？
  	  ...
  	  var queryUrl = '${pageContext.request.contextPath}/countingLogs';
  	  $table = $('#countingLog_table').bootstrapTable({
