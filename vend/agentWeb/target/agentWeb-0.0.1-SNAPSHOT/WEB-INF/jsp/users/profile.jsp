        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="#userCashConfig" data-toggle="tab">提现配置</a></li>
            </ul>
            <div class="tab-content">
              ...
              <div class="tab-pane" id="userCashConfig">
                <div id="toolbar">
                ...
                <table id="userCashConfig_table"></table>
              </div>
              <!-- /.tab-pane -->
            </div>
            <!-- /.tab-content -->
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Default Modal</h4>
              ...
              <!-- form start -->
          <form class="form-horizontal" id="cash-config-form" action="${pageContext.request.contextPath }/userCashConfigs">
      ...
      $(function(){
          ...
          $("form[id='cash-config-form']").bootstrapValidator({
        	  ...
        	  var id = $form.find("input[name='id']").val();
		  	  //提交数据
	  	      request.ajax(request.contextPath+"/userCashConfigs/"+id,id?"put":"post",$form.serialize(),true,function(data){
  	  	          if(data.success){
      	  ...
      	  var queryUrl = '${pageContext.request.contextPath}/userCashConfigs';
      	  var $table = $('#userCashConfig_table').bootstrapTable({
          ...
          $("#toolbar > button").click(function(){
        	  ...
        	  if("add"==ope){
	    		...
	    		if("delete"==ope){
	    			...
	    			request.ajax("${pageContext.request.contextPath}/userCashConfigs/"+ids,"delete",{},true,function(data){
	    				if(data.success){
	    					$table.bootstrapTable('refresh');
	    				}else{
	    					tip.error(data.msg);
	    			...
	    			//界面跳转
	    			request.ajax("${pageContext.request.contextPath}/userCashConfigs/"+idArray[0],"PUT",{},true,function(data){
	    				if(data.success){
	    					data = data.data;
