...
<html>
  ...
  <div class="login-box">
    ...
    <div class="login-box-body">
      ...
      <div id="changeBtn" class="social-auth-links text-center">
        <a href="${pageContext.request.contextPath}/session/user/new" class="btn btn-block btn-social btn-facebook btn-flat"><i class="fa fa-facebook"></i>商户入口</a>
      </div>
      <!-- 
  ...
  <script type="text/javascript">
      $(function(){
        ...
        request.ajax(request.contextPath +'/session','POST',"openId=${openId}&type=agent",false,function(result){
          if(result.success){
