...
<body class="hold-transition skin-blue sidebar-mini">
          ...
          <div class="col-xs-12">
            <div class="box box-success">
              ...
              <div class="box-body">
                ...
                <div id="toolbar">
                  <mz:menuTag menuURL="/roles/add">
                    <a href="${pageContext.request.contextPath}/roles/new" type="button" class="btn bg-maroon btn-flat">添加</a>
                  </mz:menuTag>
                  
                  <mz:menuTag menuURL="/roles/delete">
                    <button type="button" data-ope="delete" class="btn bg-olive btn-flat">删除</button>
                  </mz:menuTag>
                  
                  <mz:menuTag menuURL="/roles/edit">
  ...
  <script type="text/javascript">
	  ...
	  //节点创建的时候触发
	  function zTreeOnNodeCreated(event, treeId, treeNode) { //id
      ...
      function getAsyncURL(treeId,treeNode){  
          return request.contextPath+"/agents/menus";
      }
  	   //授权
  	  var setting = {
	      async: {
      ...
      $(function (){
      	  ...
      	  $("#toolbar > button").click(function(){
      	  	  ...
      	  	  if("delete"==ope){
      	  	  	  ...
      	  	  	  request.ajax("${pageContext.request.contextPath}/roles/"+ids,"delete",{},true,function(data){
      	  	  	  	  if(data.success){
      	  	  	  ...
      	  	  	  //界面跳转
      	  	  	  window.location.href="${pageContext.request.contextPath}/roles/"+idArray[0]+"/edit";
      	  	  }
      	  });
          ...
          function actionFormatter(value, row, index) {
  	      ...
  	      $("#modal-auth button[id='save-auth-btn']").on("click",function(e){
		  	  ...
		  	  //提交数据
	  	      request.ajax(request.contextPath+"/roles/"+roleId+"/menus","put",{"menuIds":menuIdArray.toString()},true,function(data){
  	  	          if(data.success){
  	      ...
  	      //监听操作
          $("table[id='role_table']").on("click","td > a",function(e){
        	  menuIds = [];
              ...
              if(obj.data("ope") === 'auth'){  //授权
            	  ...
            	  //加载当前角色的权限
            	  request.ajax(request.contextPath+"/roles/"+obj.data("id")+"/menus","POST",{},true,function(data){
  	  	              if(data.success){
  	  	            	  menuIds = data.data;
