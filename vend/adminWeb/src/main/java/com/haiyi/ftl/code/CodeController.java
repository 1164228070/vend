...
public class CodeController {
	...
	public static void main(String[] args) throws Exception { 
		...
		String tableName = "agent_role";
		String smallClassName = "agentRole";
		String msg = "代理角色";    //
	...
	public static void IDao(String templateName,  Map<String,Object> dataModel) throws Exception{
		...
		FileWriter fileWriter = new FileWriter("C:\\customer\\daoSupport\\src\\main\\java\\com\\haiyi\\dao\\"+dataModel.get("className")+"Mapper.java");
	...
	public static void IService(String templateName,  Map<String,Object> dataModel) throws Exception{
		Template template = cfg.getTemplate(templateName);
		FileWriter fileWriter = new FileWriter("src/main/java/com/haiyi/service/"+dataModel.get("className")+"Service.java");
		template.process(dataModel,fileWriter);
	}
	...
	public static void ServiceImpl(String templateName,  Map<String,Object> dataModel) throws Exception{
		Template template = cfg.getTemplate(templateName);
		FileWriter fileWriter = new FileWriter("src/main/java/com/haiyi/service/impl/"+dataModel.get("className")+"ServiceImpl.java");
		template.process(dataModel,fileWriter);
	}
	...
	public static void Mapper(String templateName,  Map<String,Object> dataModel) throws Exception{
		Template template = cfg.getTemplate(templateName);
		FileWriter fileWriter = new FileWriter("C:\\customer\\daoSupport\\src\\main\\resources\\mapper\\"+dataModel.get("className")+"Mapper.xml");
		template.process(dataModel,fileWriter);
	}
	...
	public static void Query(String templateName,  Map<String,Object> dataModel) throws Exception{
		Template template = cfg.getTemplate(templateName);
		FileWriter fileWriter = new FileWriter("C:\\customer\\daoSupport\\src\\main\\java\\com\\haiyi\\query\\"+dataModel.get("className")+"Query.java");
		template.process(dataModel,fileWriter);
	}
	...
	public static void Controller(String templateName,  Map<String,Object> dataModel) throws Exception{
		Template template = cfg.getTemplate(templateName);
		FileWriter fileWriter = new FileWriter("src/main/java/com/haiyi/controller/"+dataModel.get("className")+"Controller.java");
		template.process(dataModel,fileWriter);
	}
	...
	public static void Save(String templateName,  Map<String,Object> dataModel) throws Exception{
		...
		Template template = cfg.getTemplate(templateName);
		FileWriter fileWriter = new FileWriter("src/main/webapp/WEB-INF/jsp/"+dataModel.get("smallClassName")+"s/save.jsp");
		template.process(dataModel,fileWriter);
	}
	/**
	 * 生成list
	...
	public static void List(String templateName,  Map<String,Object> dataModel) throws Exception{
		...
		Template template = cfg.getTemplate(templateName);
		FileWriter fileWriter = new FileWriter("src/main/webapp/WEB-INF/jsp/"+dataModel.get("smallClassName")+"s/list.jsp");
		template.process(dataModel,fileWriter);
	}
	...
	public static void Domain(String templateName,  Map<String,Object> dataModel) throws Exception{
		...
		Template template = cfg.getTemplate(templateName);
		FileWriter fileWriter = new FileWriter("C:\\customer\\daoSupport\\src\\main\\java\\com\\haiyi\\domain\\"+dataModel.get("className")+".java");
		template.process(dataModel,fileWriter);
	}
}