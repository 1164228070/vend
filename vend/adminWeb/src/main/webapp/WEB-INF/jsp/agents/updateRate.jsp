              ...
              <div class="box-body">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input name="rate"  cssClass="form-control" placeholder="费率" data-bv-notempty="true"/>
                    </div>
                  </div>
  ...
  <script type="text/javascript">
    $(function(){
        ...
        $("#updateRate").click(function () {
            ...
            request.ajax("${pageContext.request.contextPath }/agents/updateRate/${ids}","PUT",params,true,function(data){
                if(data.success){
