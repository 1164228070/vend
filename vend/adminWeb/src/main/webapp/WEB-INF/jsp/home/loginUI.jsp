...
<html>
  ...
  <div class="login-box">
    ...
    <div class="login-box-body">
      ...
      <form name="session-creation"  method="post">
       <%-- <input id="weChat" name="openId" type="hidden">--%>
  ...
  <script type="text/javascript">
      $(function(){
        ...
        /*request.ajax(request.contextPath +'/sessionTest','POST',"",false,function(result){
          if(result.success){
        ...
        if(is_weixin()){
          request.ajax(request.contextPath +'/sessionTest','POST',"openId=${openId}",false,function(result){
            if(result.success){
              window.location.href=request.contextPath;
            }else{
              tip.error(result.msg);
