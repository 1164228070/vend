...
<footer class="main-footer">
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <div class="tab-content">
      <!-- Home tab content -->
      <div class="tab-pane" id="control-sidebar-home-tab"  style="display:none;">
      ...
      <!-- /.tab-pane -->
      <!-- Stats tab content -->
      <div class="tab-pane" id="control-sidebar-stats-tab"  style="display:none;">Stats Tab Content</div>
      <!-- /.tab-pane -->
