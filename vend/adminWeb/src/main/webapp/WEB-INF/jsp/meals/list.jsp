          ...
          <div class="col-xs-12">
            <div class="box box-success">
              ...
              <div class="box-body">
                ...
                <div id="toolbar">
                  <mz:menuTag menuURL="meals/new">
                    <a href="${pageContext.request.contextPath}/meals/new" type="button" class="btn bg-maroon btn-flat">添加</a>
                  </mz:menuTag>
                  
                  <mz:menuTag menuURL="meals/delete">
                    <button type="button" data-ope="delete" class="btn bg-olive btn-flat">删除</button>
                  </mz:menuTag>
                  
                  <mz:menuTag menuURL="meals/update">
      ...
      var conditionParams;
    	...
    	$("#toolbar > button").click(function(){
    		...
    		if("delete"==ope){
    			...
    			request.ajax("${pageContext.request.contextPath}/meals/"+ids,"delete",{},true,function(data){
    				if(data.success){
    					//TODO 确保参数问题？？？？
    			...
    			//界面跳转
    			window.location.href="${pageContext.request.contextPath}/meals/"+idArray[0]+"/edit";
    		}
    	});
    	
  	  var queryUrl = '${pageContext.request.contextPath}/meals';
  	  $table = $('#meal_table').bootstrapTable({
