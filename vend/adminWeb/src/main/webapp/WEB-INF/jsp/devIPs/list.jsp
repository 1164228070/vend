          ...
          <div class="col-xs-12">
            <div class="box box-success">
              ...
              <div class="box-body">
                ...
                <div id="toolbar">
                  <mz:menuTag menuURL="devIPs/new">
                    <a href="${pageContext.request.contextPath}/devIPs/new" type="button" class="btn bg-maroon btn-flat">添加</a>
                  </mz:menuTag>
                  
                  <mz:menuTag menuURL="devIPs/delete">
                    <button type="button" data-ope="delete" class="btn bg-olive btn-flat">删除</button>
                  </mz:menuTag>
                  
                  <mz:menuTag menuURL="devIPs/update">
                    <button type="button" data-ope="edit" class="btn bg-orange btn-flat">编辑</button>
                  </mz:menuTag>
                </div>
       
                <table id="devIP_table">
                </table>
              </div>
              <!-- /.box-body -->
            </div>
      ...
      var conditionParams;
    	...
    	$("#toolbar > button").click(function(){
    		...
    		if("delete"==ope){
    			...
    			request.ajax("${pageContext.request.contextPath}/devIPs/"+ids,"delete",{},true,function(data){
    				if(data.success){
    					//TODO 确保参数问题？？？？
    			...
    			//界面跳转
    			window.location.href="${pageContext.request.contextPath}/devIPs/"+idArray[0]+"/edit";
    		}
    	});
    	
  	  var queryUrl = '${pageContext.request.contextPath}/devIPs';
  	  $table = $('#devIP_table').bootstrapTable({
