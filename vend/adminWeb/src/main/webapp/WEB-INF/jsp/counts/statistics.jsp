...
<div class="wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-xs-8">
                    ...
                    <div class="small-box bg-green">
                        <div class="inner">
                            <h3 id="AllAgents">0</h3>
                            <p>代理商数</p>
                        </div>
                        <div class="icon">
                            <i class="ion ion-stats-bars"></i>
                        </div>
                        <a href="${pageContext.request.contextPath}/agents" class="small-box-footer">更多信息<i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-4 col-xs-8">
                    ...
                    <div class="small-box bg-yellow">
                        ...
                        <a href="${pageContext.request.contextPath}/users" class="small-box-footer">更多信息<i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-4 col-xs-8">
                ...
                <%--<section class="col-lg-6 connectedSortable">
                    ...
                    <div class="box box-danger">
                        ...
                        <div class="box-body chart-responsive">
                            <div id="memberWeekMoney" style="width:600px;height:400px;"></div>
                        </div>
                        <!-- /.box-body -->
                    </div>
                    <!-- /.box -->
                ...
                <section class="col-lg-6 connectedSortable">
                    ...
                    <div class="box box-danger">
                        ...
                        <div class="box-body chart-responsive">
                            <div id="memberMonthMoney" style="width:600px;height:400px;"></div>
                        </div>
                        <!-- /.box-body -->
                    </div>--%>
                    <!-- /.box -->
                    ...
                    <form id="searchForm" action="" onsubmit="return false;" class="form-inline">
                        <div class="form-group">
                            <select class="form-control" name="key" id="query_key">
                                ...
                                <option value="userName">商户</option>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            request.ajax("${pageContext.request.contextPath}/counts/manageCounts","POST",{},true,function(data){
                if(data.success){
                    $("#AllMembers").text(data.data.members);
                    $("#AllAgents").text(data.data.agents);
                    $("#AllUsers").text(data.data.users);
                    $("#AllDevs").text(data.data.devs);
                }
            });
            request.ajax("${pageContext.request.contextPath}/comsumeLogs/getComsumeCounts","POST",{},true,function(data){
                if(data.success){
...
/*
            ...
            //会员周充值统计
            request.ajax("${pageContext.request.contextPath}/counts/getMemberWeekCounts","POST",{},true,function(data){
                if(data.success){
                    var myChart3 = echarts.init(document.getElementById('memberWeekMoney'));
                    var option3 = {
                        color: ['#3398DB'],
                        tooltip : {
                            trigger: 'axis',
                        ...
                        xAxis : [
                            {
                                name:"时间轴",
                                type : 'category',
                                data : ["今天","前一天","前两天","前三天","前四天","前五天","前六天"],
                                axisTick: {
                                    alignWithLabel: true
                                }
                            }
            ...
            //会员充值月统计
            request.ajax("${pageContext.request.contextPath}/counts/getMemberMonthCounts","POST",{},true,function(data){
                if(data.success){
                    var myChart4 = echarts.init(document.getElementById('memberMonthMoney'));
                    var option4 = {
                        tooltip : {
                            trigger: 'axis'
                        },
                        xAxis: {
                            name:"时间轴",
                            type: 'category',
                            data: ['4-5周内', '3-4周内', '2-3周内', '1-2周内', '1周内']
                        },
                        yAxis: {
                            name:"金额(单位元)",
                            type: 'value'
