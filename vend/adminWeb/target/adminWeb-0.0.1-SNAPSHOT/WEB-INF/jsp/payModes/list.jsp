          ...
          <div class="col-xs-12">
            <div class="box box-success">
              ...
              <div class="box-body">
                ...
                <div id="toolbar">
 <%--                 <mz:menuTag menuURL="payModes/new">
                    <a href="${pageContext.request.contextPath}/payModes/new" type="button" class="btn bg-maroon btn-flat">添加</a>
                  </mz:menuTag>
                  
                  <mz:menuTag menuURL="payModes/delete">
                    <button type="button" data-ope="delete" class="btn bg-olive btn-flat">删除</button>
                  </mz:menuTag>--%>
                  
                  <mz:menuTag menuURL="payModes/update">
                    <button type="button" data-ope="edit" class="btn bg-orange btn-flat">编辑</button>
                  </mz:menuTag>
                </div>
       
                <table id="payMode_table">
                </table>
              </div>
              <!-- /.box-body -->
            </div>
  ...
  <script type="text/javascript">
      ...
      var conditionParams;
    	...
    	$("#toolbar > button").click(function(){
    		...
    		if("delete"==ope){
    			...
    			request.ajax("${pageContext.request.contextPath}/payModes/"+ids,"delete",{},true,function(data){
    				if(data.success){
    					//TODO 确保参数问题？？？？
    			...
    			//界面跳转
    			window.location.href="${pageContext.request.contextPath}/payModes/"+idArray[0]+"/edit";
    		}
    	});
    	
  	  var queryUrl = '${pageContext.request.contextPath}/payModes';
  	  $table = $('#payMode_table').bootstrapTable({
    ...
    function nameFormatter (value,row,index) {
      return value==1?"直连微信支付宝":(value==2?"中信支付":"未知,请尽快选择支付模式");
    }
