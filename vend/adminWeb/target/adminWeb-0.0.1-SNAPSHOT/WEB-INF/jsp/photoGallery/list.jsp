                ...
                <div class="col-xs-12">
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                                ...
                                <div class="row">
                                    <form id="searchForm" action="" onsubmit="return false; "  class="form-inline">
                                        ...
                                        <div class="form-group">
                                            <input type="text" id="photoName" name="photoName" class="form-control" placeholder="图片库名">
                                        </div>
                                        <div class="form-group">
                            ...
                            <div id="toolbar">
                                <mz:menuTag menuURL="/photoGallery/add">
                                    <a href="${pageContext.request.contextPath}/photoGallery/new" type="button" class="btn bg-maroon btn-flat">添加</a>
                                </mz:menuTag>

                                <mz:menuTag menuURL="/photoGallery/delete">
                                    <button type="button" data-ope="delete" class="btn bg-olive btn-flat">删除</button>
                                </mz:menuTag>

                                <mz:menuTag menuURL="/photoGallery/edit">
...
<script type="text/javascript">
    $(function (){
        ...
        $("#toolbar > button").click(function(){
            ...
            if("delete"==ope){
                ...
                request.ajax("${pageContext.request.contextPath}/photoGallery/"+ids,"delete",{},true,function(data){
                    if(data.success){
                        //TODO 确保参数问题？？？？
                ...
                //界面跳转
                window.location.href="${pageContext.request.contextPath}/photoGallery/"+idArray[0]+"/edit";
            }
        });

        var queryUrl = '${pageContext.request.contextPath}/photoGallery';
    ...
    function nameFormatter (value,row,index) {
        return '<a href="'+request.contextPath+'/photoGallery/'+row.id+'">'+value+'</a>';
    }
