...
<script type="text/javascript">
    ...
    $(function(){
        //发送ajax请求
        request.ajax("http://www.peshion.com/apiWeb/pay/wxpay/zx_unifiedorder/${orderId}?code=${code}","POST",{},false,function(result){
            if(result.success){
                payInfo = JSON.parse(result.data.pay_info);
